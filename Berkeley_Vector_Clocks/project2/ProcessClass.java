...
public class ProcessClass implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("Ordered Multicasting using Vector Clocks - Started");
        initVectorClock();
    ...
    private void calculateAverage() {
        try {
            ...
            System.out.println("Coordinator (Process " + processID + ") Previous Time : " + previous_time + " ----> Current Time : " + counter);
    ...
    private void changeTime() {
        try {
            ...
            if (requestMsg.getType().equals(MessageType.CHANGE_TIME)) {
                ...
                System.out.println("Process " + processID + " Previous Time : " + previous_time + " ----> Current Time : " + counter);
